...
const VISUALS = {
  ...
  "korea|Daejeon-Metro-1|1호선": { shape: "metro", body: "#f8fafc", accent: "#007448", band: "#007448" },
  "korea|Gwangju-Metro-1|1호선": { shape: "metro", body: "#f8fafc", accent: "#009088", band: "#009088" },
  ...
  "korea|Busan-Gimhae-LRT|BGL": { shape: "metro", body: "#f8fafc", accent: "#8652A1", band: "#8652A1" },
  ...
  "singapore|SG-MRT-North-East|NEL": { shape: "metro", body: "#f8fafc", accent: "#9900aa", band: "#9900aa" },
  ...
  "singapore|SG-LRT-Punggol|PGLRT": { shape: "metro", body: "#f8fafc", accent: "#748477", band: "#748477" },
  ...
  "malaysia|KL-LRT-Sri-Petaling|SPL": { shape: "metro", body: "#f8fafc", accent: "#721422", band: "#721422" },
  ...
  "thailand|BKK-MRT-Pink-Muang-Thong-Thani|PK": { shape: "monorail", body: "#fff1f2", accent: "#e76589", band: "#be185d" },
  ...
  "philippines|MNL-LRT-2|LRT-2": { shape: "metro", body: "#f8fafc", accent: "#7c3aed", band: "#7c3aed" },
