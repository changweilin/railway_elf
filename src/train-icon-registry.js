...
export const TRAIN_ICON_REGISTRY = {
  ...
  lineOverrides: {
    ...
    'japan|Utsunomiya-Lightline|ライトライン': { icon: 'assets/train-icons/japan-utsunomiya-lightline-lightline.png', kind: 'lrt' },
    ...
    'korea|Seoul-Metro-3|3호선': { icon: 'assets/train-icons/korea-seoul-metro-3-line-3.png', kind: 'metro' },
    'korea|Seoul-Metro-4|4호선': { icon: 'assets/train-icons/korea-seoul-metro-4-line-4.png', kind: 'metro' },
    'korea|Seoul-Metro-5|5호선': { icon: 'assets/train-icons/korea-seoul-metro-5-line-5.png', kind: 'metro' },
    'korea|Seoul-Metro-6|6호선': { icon: 'assets/train-icons/korea-seoul-metro-6-line-6.png', kind: 'metro' },
    'korea|Seoul-Metro-7|7호선': { icon: 'assets/train-icons/korea-seoul-metro-7-line-7.png', kind: 'metro' },
    'korea|Seoul-Metro-8|8호선': { icon: 'assets/train-icons/korea-seoul-metro-8-line-8.png', kind: 'metro' },
    'korea|Seoul-Metro-9|9호선': { icon: 'assets/train-icons/korea-seoul-metro-9-line-9.png', kind: 'metro' },
    'korea|Ui-LRT|우이신설선': { icon: 'assets/train-icons/korea-ui-lrt-ui-sinseol-line.png', kind: 'lrt' },
    'korea|Sillim-LRT|신림선': { icon: 'assets/train-icons/korea-sillim-lrt-sillim-line.png', kind: 'lrt' },
    ...
    'korea|Gyeonggang|경강선': { icon: 'assets/train-icons/korea-gyeonggang-gyeonggang.png', kind: 'commuter' },
    'korea|Seohae|서해선': { icon: 'assets/train-icons/korea-seohae-seohae.png', kind: 'commuter' },
    'korea|Incheon-Metro-1|1호선': { icon: 'assets/train-icons/korea-incheon-metro-1-line-1.png', kind: 'metro' },
    'korea|Incheon-Metro-2|2호선': { icon: 'assets/train-icons/korea-incheon-metro-2-line-2.png', kind: 'lrt' },
    ...
    'korea|Daegu-Metro-1|1호선': { icon: 'assets/train-icons/korea-daegu-metro-1-line-1.png', kind: 'metro' },
    ...
    'korea|KTX-Gyeongjeon|KTX-산천': { icon: 'assets/train-icons/korea-ktx-gyeongbu-ktx-sancheon.png', kind: 'shinkansen' },
    'korea|KTX-Gangneung|KTX-이음': { icon: 'assets/train-icons/korea-ktx-gangneung-ktx-eum.png', kind: 'shinkansen' },
    'korea|KTX-Donghae|KTX': { icon: 'assets/train-icons/korea-ktx-gyeongbu-ktx.png', kind: 'shinkansen' },
    'korea|KTX-Donghae|KTX-산천': { icon: 'assets/train-icons/korea-ktx-gyeongbu-ktx-sancheon.png', kind: 'shinkansen' },
    'korea|KTX-Jungang|KTX-이음': { icon: 'assets/train-icons/korea-ktx-gangneung-ktx-eum.png', kind: 'shinkansen' },
    'korea|KTX-Jungbu-Naeryuk|KTX-이음': { icon: 'assets/train-icons/korea-ktx-gangneung-ktx-eum.png', kind: 'shinkansen' },
    'korea|ITX-Cheongchun|ITX-청춘': { icon: 'assets/train-icons/korea-itx-cheongchun-itx-cheongchun.png', kind: 'express' },
