...
| P1-PH | 菲律賓 | Manila LRT-1、LRT-2、MRT-3、PNR / NSCR future corridor | `MNL-MRT-3` Manila MRT-3 current-service seed 已完成（North Avenue ⇄ Taft Avenue，13 站） | LRT-1 extension、LRT-2 west extension、PNR / NSCR future corridor 需確認 current baseline；PNR / NSCR 類長線不併入本 seed |
...
5. P1 前兩條 seed 已完成：印尼 `JKT-MRT-North-South`（Jakarta MRT North-South Phase 1，Lebak Bulus ⇄ Bundaran HI）與菲律賓 `MNL-MRT-3`（North Avenue ⇄ Taft Avenue，13 站）。多 region UI 已決定維持原生 select，12+ regions 時改為群組化 select。
...
- `report`: 後續 5.3 seed 新增/修改 region 1、line 1、station 13、train template 1、shape mapping 1、icon override 1；`MNL-MRT-3` 已完成為 P1 Manila MRT-3 seed（shape total 16.658 km, maxOffset 0.005 km, 30 pts）。目前無明確下一個 5.3 seed。
