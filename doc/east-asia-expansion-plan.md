...
| ◐ seed | LRT / AGT | 輕量捷運與無人自動運轉線 | Gimpo Goldline（☑ A ☑ B）、Incheon 2（☑ A ☑ B）、Ui LRT（☑ A ☑ B）、Sillim Line（☑ A ☑ B）；Uijeongbu U Line、Yongin EverLine、Busan-Gimhae LRT 等待後續 | OSM + operator data | Gimpo Goldline、Incheon 2、Ui LRT 與 Sillim Line 已作為 low-capacity / driverless seeds；Sillim 圖示先檢查 Gimpo / Incheon / Ui 既有 LRT，但 Woojin SL000 / K-AGT 與 파란색塗裝不同而新增 line-aware 圖示；後續可沿用或擴充此圖示風格 |
...
| LRT | 4 | Gimpo Goldline、Incheon 2、Ui LRT、Sillim Line（台灣側已涵蓋淡海、高雄環狀輕軌） |
