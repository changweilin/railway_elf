...
| ◐ seed | LRT / AGT | 輕量捷運與無人自動運轉線 | Gimpo Goldline（☑ A ☑ B）、Incheon 2（☑ A ☑ B）、Ui LRT（☑ A ☑ B）、Sillim Line（☑ A ☑ B）、Uijeongbu U Line（☑ A ☑ B）、Yongin EverLine（☑ A ☑ B）；Busan-Gimhae LRT 等待後續 | OSM + operator data | Gimpo Goldline、Incheon 2、Ui LRT、Sillim Line、Uijeongbu U Line 與 Yongin EverLine 已作為 low-capacity / driverless seeds；Yongin 圖示先檢查 Gimpo / Incheon / Ui / Sillim / Uijeongbu 既有 LRT/AGT，但 Bombardier Innovia ART / EverLine 綠色塗裝不同而新增 line-aware 圖示；後續可沿用或擴充此圖示風格 |
...
| LRT | 6 | Gimpo Goldline、Incheon 2、Ui LRT、Sillim Line、Uijeongbu U Line、Yongin EverLine（台灣側已涵蓋淡海、高雄環狀輕軌） |
...
- **站點座標品質**：本輪沒有 0 km fallback；中國 HSR、TYMRT、Alishan、台鐵支線與高捷紅/輕軌等粗略站點座標已用 generated OSM shape 做 1 km 門檻吸附。`TPE-Brown`、`KHH-Orange`、`Busan-Metro-1/2/3/4`、`Daegu-Metro-1/2`、`Daejeon-Metro-1`、`Gwangju-Metro-1`、`Beijing-Subway-1`、`Shanghai-Metro-1/2`、`KL-Kelana-Jaya`、`BKK-BTS-Sukhumvit`、`BKK-MRT-Blue`、`HCMC-Metro-1`、`Hanoi-Metro-2A` 已直接採用 OSM relation stop/platform node 對站。
